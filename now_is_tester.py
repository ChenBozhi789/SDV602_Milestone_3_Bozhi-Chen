...
from controller import make_des_one
from controller import make_des_two
from controller import make_des_three
...
def main():
    ...
    while True:
        ...
        # When user click login button
            ...
            # If current window not exists, then create it in the list
            if current_window not in list_of_window_references:
                if current_window == 1:
                    list_of_window_references[1] = make_DES_Two()
